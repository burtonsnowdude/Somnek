"""
dictionnaire_armes.py — SOMNEK
Contient tous les dicos liés aux armes :
  - GESTION_DES_ARMES        : effets et plafonds pour le système d'upgrade
  - TYPES_ARMES              : données complètes par arme (type, image, dgbase, texte)
  - ARMES                    : TYPES_ARMES + niveau requis pour débloquer
  - GESTION_DES_NIVEAUX_ARMES: armes proposées à chaque niveau par perso
"""

from Fichiers_variables.traitement_images import *

# plafonds des armes pour le système d'upgrade 
GESTION_DES_ARMES = {
    ...
    "Nerd": {
        ...
        "Epee_bleue":      {"effet": "degats",  "max": 10}
    },
...
# données complètes de chaque arme : type, image, texte d'aide, dégats de base
TYPES_ARMES = {
    ...
    "Nerd": {
        ...
        "Epee_enflammee": {
            "type_arme": "coup",
            "image":     EPEE_ENFLAMMEE_img,
            # frames pour l'anim de l'épée enflammée
            "frames":    EPEE_ENFLAMMEE,
            "fps":       12,
            "texte":     "Epée et feu, un mix . Dégât de base : 10PV",
            "dgbase":    20
        },
        ...
        "Console_allumee": {
            ...
            # pas de dgbase, arme à effet spécial
        }
    },
...
# TYPES_ARMES + niveau requis pour débloquer chaque arme
ARMES = {

    "Nerd": {
        "Epee_bleue":      {**TYPES_ARMES["Nerd"]["Epee_bleue"],      "niveau_req": 1},
        "Cle_USB":         {**TYPES_ARMES["Nerd"]["Cle_USB"],         "niveau_req": 4},
        "Epee_enflammee":  {**TYPES_ARMES["Nerd"]["Epee_enflammee"],  "niveau_req": 4},
        "Pistolets":       {**TYPES_ARMES["Nerd"]["Pistolets"],       "niveau_req": 5},
        "Ticket_de_metro": {**TYPES_ARMES["Nerd"]["Ticket_de_metro"], "niveau_req": 19},
        "Epee_de_Guts":    {**TYPES_ARMES["Nerd"]["Epee_de_Guts"],    "niveau_req": 24},
    },

    "Fille_populaire": {
        "Gloss_rose":           {**TYPES_ARMES["Fille_populaire"]["Gloss_rose"],           "niveau_req": 1},
        "Faux_cils":            {**TYPES_ARMES["Fille_populaire"]["Faux_cils"],            "niveau_req": 1},
        "Faux_ongles_roses":    {**TYPES_ARMES["Fille_populaire"]["Faux_ongles_roses"],    "niveau_req": 4},
        "Bracelet_de_sa_soeur": {**TYPES_ARMES["Fille_populaire"]["Bracelet_de_sa_soeur"],"niveau_req": 4},
        "Fer_a_lisser":         {**TYPES_ARMES["Fille_populaire"]["Fer_a_lisser"],         "niveau_req": 5},
        "Pass_Navigo":          {**TYPES_ARMES["Fille_populaire"]["Pass_Navigo"],          "niveau_req": 19},
        "Ring_light":           {**TYPES_ARMES["Fille_populaire"]["Ring_light"],           "niveau_req": 24},
        "Highlighter":          {**TYPES_ARMES["Fille_populaire"]["Highlighter"],          "niveau_req": 10},
    },

    "Nonne": {
        "Croix_marron":          {**TYPES_ARMES["Nonne"]["Croix_marron"],          "niveau_req": 0},
        "Feu_de_l'Esprit_Saint": {**TYPES_ARMES["Nonne"]["Feu_de_l'Esprit_Saint"],"niveau_req": 4},
        "Medaille_de_bapteme":   {**TYPES_ARMES["Nonne"]["Medaille_de_bapteme"],   "niveau_req": 4},
        "Coiffe_de_rameau":      {**TYPES_ARMES["Nonne"]["Coiffe_de_rameau"],      "niveau_req": 5},
        "Lance_sacree":          {**TYPES_ARMES["Nonne"]["Lance_sacree"],          "niveau_req": 19},
        # correction : était Ring_light → Aura_divine
        "Aura_divine":           {**TYPES_ARMES["Nonne"]["Aura_divine"],           "niveau_req": 24},
        "JALAMBAYA":             {**TYPES_ARMES["Nonne"]["JALAMBAYA"],             "niveau_req": 28},
    }
}

# armes proposées au joueur à chaque niveau — pour le choix au level-up
