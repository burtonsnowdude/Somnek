"""
dictionnaire_items.py — SOMNEK
Contient tous les dicos d'items du jeu :
  - Items        : catalogue des items par perso avec leur effet et leur max
  - GESTION_NIVEAU_ITEMS : valeurs des items débloqués à chaque niveau
  - TYPES_ITEMS  : images et textes d'affichage 
  - ITEMS_PAR_PERSO : Items utilisé par Item_system.py
"""

import pygame as pyg
from Fichiers_variables.traitement_images import *

# catalogue principal — un item par perso avec son effet et son plafond
Items = {
    "Fille_populaire": {
    ...
    "Nonne": {
        # item multi-effets avec des sous-stats
        "Eau_benite": {
            "effet":    "multi",
            "vitesse":  0.10,
            "sante":    0.12,
...
# valeurs des items gagnés à chaque niveau pour chaque perso
GESTION_NIVEAU_ITEMS = {
    ...
    "Nerd": {
        ...
        "Niveau 3":  {"Pomme_scientifique": 0.05, "Souris_pc": 0.05, "Cahier_NSI": 0.08},
        "Niveau 4":  {},
        "Niveau 5":  {"Lunettes_cassees": 0.05, "Chaussettes_propres": 0.05},
        "Niveau 6":  {"Petit_nain_roux": 0.07, "Lunettes_cassees": 0.05, "Pomme_scientifique": 0.05},
        "Niveau 7":  {"Armure de bronze": 0.20},
        "Niveau 8":  {"Souris_pc": 0.05, "Cahier_NSI": 0.08},
        "Niveau 9":  {"Vody_Lemonade": 0.20, "Cahier_NSI": 0.08},
        "Niveau 10": {"Armure de bronze": 0.10},
        "Niveau 11": {"Vody_Lemonade": 0.15, "Apple_Watch": 1.5},
        "Niveau 12": {"Vody_Lemonade": 0.05, "Cahier_NSI": 0.06},
        "Niveau 13": {"Souris_pc": 0.05, "Chaussettes_propres": 0.05, "Lunettes_cassees": 0.05},
        "Niveau 14": {"Pomme_scientifique": 0.02, "Deodorant": 0.03, "Chariot Violet": 0.18},
        "Niveau 15": {"Deodorant": 0.13, "Armure de bronze": 0.10},
        "Niveau 16": {"Deodorant": 0.13},
        "Niveau 17": {"Pomme_scientifique": 0.08, "Cahier_NSI": 0.15, "Deodorant": 0.03},
        "Niveau 18": {"Pomme_scientifique": 0.08, "Serviette_nettoyante": 0.6},
        "Niveau 19": {"Serviette_nettoyante": 0.6},
        "Niveau 20": {"Mousse_vanille": 0.9},
        "Niveau 21": {"Chaussettes_propres": 0.05},
        "Niveau 22": {"Vody_Lemonade": 0.35, "Serviette_nettoyante": 3, "Ambroisie": 0.50},
        "Niveau 23": {"Apple_Watch": 1.8, "Vody_Lemonade": 0.15},
        "Niveau 24": {"Vody_Lemonade": 0.15},
        "Niveau 25": {"Armure_chevalier": 0.50, "Pantalon_beige": 0.27},
        "Niveau 26": {"Lunettes_cassees": 0.05}
    },
    ...
    "Fille_populaire": {
        ...
        "Niveau 6":  {"Mousse_vanille": 0.10, "Coque_trefle": 0.07, "Talons_noirs": 0.5},
        "Niveau 7":  {"Crop_top_rose": 0.20},
        "Niveau 8":  {"Carte_bleue": 0.05},
        "Niveau 9":  {"Chargeur": 0.20},
        "Niveau 10": {"Crop_top_rose": 0.01},
        "Niveau 11": {"Mousse_vanille": 0.09, "Minuteur": 0.5},
...
# infos d'affichage — image et texte pour chaque item dans l'interface
TYPES_ITEMS = {
    ...
    "Nerd": {
        ...
        "Deodorant":            {"image": DEODORANT,           "texte": "Réduit le cooldown des attaques."},
        ...
        "Apple_Watch":          {"image": APPLE_WATCH,         "texte": "Augmente la durée des effets."},
        "Ambroisie":            {"image": AMBROISIE,           "texte": "Augmente la durée des effets."},
        "Chariot Violet":       {"image": CHARIOT_VIOLET,      "texte": "Augmente la durée des effets."}
    },

    "Fille_populaire": {
        "Chew_gum":        {"image": CHEW_GUM,        "texte": "Augmente la barre de vie."},
        ...
        "Sac_main_violet": {"image": SAC_VIOLET,       "texte": "Augmente le nombre de projectiles."},
    ...
    "Nonne": {
        ...
        "Chapelet":         {"image": CHAPELET,         "texte": "Augmente la chance."},
        "Mocassin":         {"image": MOCASSIN,         "texte": "Augmente la vitesse."},
        "Tableau_sacre":    {"image": TABLEAU_SACRE,    "texte": "Réduit le cooldown."},
        ...
        "Huile_benediction":{"image": HUILE_BENEDICTION,"texte": "Réduit le cooldown."},
        ...
        "Coeur":            {"image": COEUR,            "texte": "Augmente l'attirance."},
        "Cape":             {"image": CAPE,             "texte": "Augmente la défense."},
        "Collant":          {"image": COLLANT,          "texte": "Bonus vitesse/défense."},
        "Halo":             {"image": HALO_LUMINEUX,    "texte": "Objet divin très puissant."},
        "Minuteur":         {"image": MINUTEUR,         "texte": "Augmente la durée des bonus."},
    }
}

#  utilisé par Item_system.py pour accéder au catalogue
