...
GESTION_NIVEAU_ITEMS = {
    ...
    "Fille_populaire": {
        ...
        "Niveau 24": {"Chew_gum": 0.15, "Ring_light": 0.40, "Mousse_vanille": 0.8},
...
TYPES_ITEMS = {
    ...
    "Nerd": {
        ...
        "Deodorant": {
            "image": DEMAQUILLANT,
            "texte": "Réduit le cooldown des attaques."
        },

        "Pomme_scientifique": {
            "image": POMME_SCIENTIFIQUE,
            "texte": "+2% de santé maximale"
        },

        "Petit_nain_roux": {
            "image": NAIN,
            "texte": "Augmente la chance de loot."
        },

        "Serviette_nettoyante": {
            "image": SERVIETTE,
            "texte": "Régénération de vie."
        },

        "Cle_USB": {
            "image": CLE_USB,
            "texte": "Augmente les dégâts."
        },

        "Pistolets": {
            "image": PISTOLETS,
            "texte": "Augmente la puissance d'attaque."
        },

        "Epee_enflammee": {
            "image": MOUSSE_VANILLE,
            "texte": "Inflige des dégâts de feu."
        },

        "Epee_de_guts": {
            "image": MOUSSE_VANILLE,
            "texte": "Arme légendaire très puissante."
        },

        "Armure_chevalier": {
            "image": ARMURE,
            "texte": "Réduit fortement les dégâts."
        },

        "Pantalon_beige": {
            "image": CHAUSSETTES,
            "texte": "Bonus léger de vitesse."
        }
    },
    ...
    "Fille_populaire": {
        ...
        "Carte_bleue": {
            "image": CARTE_BLEU,
            "texte": "Augmente les gains d'argent."
        },

        "Parfum_Dioru": {
            "image": PARFUM_DIORU,
            "texte": "Réduit le cooldown."
        },

        "Pilule_verte": {
            "image": PILULE_VERTE,
            "texte": "Augmente la santé max."
        },

        "Crop_top_rose": {
            "image": CROP_TOP_ROSE,
            "texte": "Réduit les dégâts."
        },

        "Coque_trefle": {
            "image": TREFLE,
            "texte": "Augmente la chance."
        },
        ...
        "Sac_main_violet": {
            "image": MOUSSE_VANILLE,
            "texte": "Augmente le nombre de projectiles."
        },

        "Chargeur": {
            "image": MOUSSE_VANILLE,
            "texte": "Augmente la durée des effets."
        },


        "Iphone_2000": {
            "image": IPHONE_2000,
            "texte": "Objet rare multi-effets."
        },

        "Minuteur": {
            "image": MOUSSE_VANILLE,
            "texte": "Augmente la durée des bonus."
        },

        "Ambroisie": {
            "image": MOUSSE_VANILLE,
            "texte": "Permet de ressusciter."
        },
    ...
    "Nonne": {
        ...
        "Eau_benite": {
            "image": EAU_BENITE,
            "texte": "Bonus multiples (vitesse, santé, etc.)."
        },
        ...
        "Bourse": {
            "image": BOURSE,
            "texte": "Augmente les gains."
        },

        "Bougie": {
            "image": BOUGIE,
            "texte": "Augmente l'attirance."
        },
        ...
        "Sac_a_dos_bleu": {
            "image": OSTIE,
            "texte": "Augmente les projectiles."
        },
        ...
        "Cape": {
            "image": VOILE,
            "texte": "Augmente la défense."
        },

        "Collant": {
            "image": VOILE,
            "texte": "Bonus vitesse/défense."
        },

        "Halo": {
            "image": CROIX_DE_BASE,
            "texte": "Objet divin très puissant."
        }
    }
}